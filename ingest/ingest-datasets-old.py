__author__ = 'szednik'
# as template, altered by Hao to fit the dataset ingest process
# archived as developing a new ingest script utilizing a sepatate .py file for common functions
